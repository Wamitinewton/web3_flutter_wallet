...
import 'package:wallet_contract/components/nft_components.dart';
import 'package:wallet_contract/components/send_tokens.dart';
import 'package:wallet_contract/pages/create_or_import.dart';
import 'package:wallet_contract/providers/wallet_provider.dart';
import 'package:wallet_contract/utils/get_balances.dart';
                  ...
                  Expanded(
                    child: TabBarView(
                      children: [
                        ...
                        // NFTs Tab
                        const SingleChildScrollView(child: NFTListPage(chain: 'eth')),
                        // Activities Tab
                        Center(
                          child: ListTile(
                            ...
                            onTap: () async {
                              ...
                              Navigator.pushAndRemoveUntil(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => const CreateOrImport(),
                                ),
                                (route) => false,
                              );
                            },
